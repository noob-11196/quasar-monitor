...
TARGET_ITEMS = {
    ...
    # --- [기타 부품 및 키워드] 무조건 알림 ---
    "LIANLI": None, "Lianli": None, "리안리": None,
    "어엘": None, "AORUS ELITE": None,
    "6000 CL30": None, "CL30": None,
    "B850M": None, "B850": None,
    "LEADEX III": None, "리덱스": None, "슈퍼플라워": None, "SuperFlower": None, "슈플": None,
    "CH270": None, "P12 PWM": None, "ARCTIC P12": None,
    "RTX": None, "지포스": None, "라데온": None, "RX": None, "그래픽카드": None,
    "RAM": None, "DDR4": None, "DDR5": None, "시금치": None, "클레브": None, "팀그룹": None, "커세어": None, "G.SKILL": None,
}
        ...
        for keyword, max_price in TARGET_ITEMS.items():
            if keyword.upper() in title_upper:
                ...
                if max_price is None or price is None or price <= max_price:
                    ...
                    price_info = f"💰 감지 가격: {price:,}원" if price else "💰 가격 정보 미기재"
